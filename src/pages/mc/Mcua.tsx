        ...
        <Layout>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <div style={{ display: 'flex', gap: 80, flexWrap: 'nowrap', alignItems: 'flex-start', justifyContent: 'center' }}>
                        <div style={{ flex: '0 0 auto', width: '600px' }}>
                            <Card style={{ height: 650 }}>
                                <CardHeader>
                                    ...
                                    <CardDescription>Introduce los valores iniciales para el cálculo del MCUA.</CardDescription>
                                </CardHeader>
                                <CardContent>
                        ...
                        <div style={{ flex: '0 0 auto', width: '1000px', height: 650 }} className="ag-theme-quartz">
                        <AgGridReact
                        theme={myTheme}
                        rowData={data}
                        columnDefs={colDefs}
